...
import { formatCommValue, CommType } from "@/spaces/packages/workspace/lib/comm-validation";
...
interface PersonFormDialogProps {
  ...
  person: (Person & { companies: CompanyWithWeb[]; comms: Comm[] }) | null;
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full max-w-none flex flex-col p-0 overflow-hidden data-[state=open]:duration-200 data-[state=closed]:duration-150">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
          ...
          <TabsContent value="companies" className="mt-4 space-y-6  p-6 overflow-x-scroll">
