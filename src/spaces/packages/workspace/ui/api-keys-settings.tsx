...
import {
  useApiKeys,
  type CreatedKey,
} from "@/spaces/packages/workspace/hooks/use-api-keys";
...
export function ApiKeysSettings() {
  const { keys, loading, forbidden, createKey, revokeKey } = useApiKeys();
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const result = await createKey(createName.trim(), [...scopes]);
      if (result) {
