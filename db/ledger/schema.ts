...
export const people = ledger.table(
  "people",
  {
...
export const companyDomains = ledger.table(
  "company_domains",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const companyWebsites = ledger.table(
  "company_websites",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
/* =========================
   PEOPLE ↔ COMPANIES (Temporal)
========================= */

export const peopleCompanies = ledger.table(
  "people_companies",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const comms = ledger.table(
  "comms",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
/* =========================
   COMMS ↔ PEOPLE (Temporal)
========================= */

export const commsPeople = ledger.table(
  "comms_people",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const commsCompanies = ledger.table(
  "comms_companies",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const emails = ledger.table(
  "emails",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const emailComms = ledger.table(
  "email_comms",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const meetings = ledger.table(
  "meetings",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const meetingsComms = ledger.table(
  "meetings_comms",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const calls = ledger.table(
  "calls",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const callComms = ledger.table(
  "call_comms",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const messages = ledger.table(
  "messages",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const messageComms = ledger.table(
  "message_comms",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
...
export const activities = ledger.table(
  "activities",
  {
    id: uuid("id").defaultRandom().primaryKey(),
    tenantId: uuid("tenant_id").notNull(),
    ...
    actorCommId: uuid("actor_comm_id"),
    actorPersonId: uuid("actor_person_id"),
    occurredAt: timestamp("occurred_at", {
      withTimezone: true,
      mode: "string",
    }).notNull(),
    accessLevel: accessLevel("access_level").default("internal").notNull(),
